...
| G5 立場檢查 | 自問：「這篇沒有我會心痛的句子是哪句？」 | 答不出來 → 退回重寫（代表只是填空，沒有個人立場） |

> **G5 立場檢查規則**：在通過 G1-G4 後、產出最終版本前，強制停頓一次。找一句「少了它我會覺得這篇白寫了」的句子。如果整篇找不出來，代表輸出只是模板填空，不具備個人立場與判斷力 — 退回重寫。這句立場句子應在結論或關鍵發現處，作為全文的靈魂句。
